...
public class JTAEnvironmentBeanService implements Service<JTAEnvironmentBean> {
    ...
    public JTAEnvironmentBeanService(final String nodeIdentifier, final boolean useActionStatusServiceRecoveryFilter) {
        this.nodeIdentifier = nodeIdentifier;
        this.useActionStatusServiceRecoveryFilter = useActionStatusServiceRecoveryFilter;
    }
